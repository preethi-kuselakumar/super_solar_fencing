        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a href="#" className="w-8 h-8 rounded-full border border-gray-800 flex items-center justify-center text-[#639922] hover:bg-[#639922] hover:text-white transition-all group">
              ...
              <a href="https://wa.me/000111123456" className="w-8 h-8 rounded-full border border-gray-800 flex items-center justify-center text-[#639922] hover:bg-[#639922] hover:text-white transition-all group">
